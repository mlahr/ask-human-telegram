...
func NewEnvClient() (Client, error) {
	...
	if token == "" {
		return Client{}, fmt.Errorf("%s environment variable is required", TokenEnvVar)
	}
...
func NotifyUsageText() string {
	return "Usage: notify-human --telegram-chat <CHAT_ID> \"<message>\"\n\n" +
		"Options:\n" +
		"  --telegram-chat <CHAT_ID>  Telegram chat ID to send the message to (defaults to ASK_HUMAN_TELEGRAM_CHAT_ID if set)\n" +
		"  --help                     Show this help text\n"
}
